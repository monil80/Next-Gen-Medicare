    ...
    return (
        ...
        <div className="about_us">
          ...
          <div className="mission">
            <span>MISSION</span>
            <p>
              Our mission is to transport  medicines with high speed and good
              quality.{" "}
            </p>
          </div>
          ...
          <span>Motive</span>
          <p>
            Next Gen Medicare offers one of a kind mix of pharmacy and magnificence facility
          ...
          <p>
            Thank you for considering Next Gen Medicare to provide your important medicine
